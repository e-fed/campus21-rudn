  ...
  <section class="py-12 sm:py-16 px-4 bg-gray-100 dark:bg-[#161D27] border-t-2 border-black">
    <div class="max-w-4xl mx-auto">
      ...
      <div class="fade-in-up bg-white dark:bg-darkBg border-4 border-black shadow-pixel p-6 sm:p-8 relative">
        ...
        <!-- Блок ВАЖНО -->
        <div class="bg-red-100 dark:bg-red-900/30 border-2 border-black p-4 sm:p-6 mb-6 shadow-pixel">
          <div class="flex items-start gap-3">
            <div class="flex-shrink-0 w-10 h-10 bg-red-600 border-2 border-black flex items-center justify-center">
              <span class="text-white font-bold text-xl">!</span>
            </div>
            <div>
              <h3 class="text-xl sm:text-2xl font-bold uppercase mb-2 text-red-600 dark:text-red-400">
                Важно!
              </h3>
              ...
              <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">
                Документы появятся в личном кабинете после установочной встречи — их можно будет скачать по ссылке.
              </p>
            </div>
          </div>
        </div>
